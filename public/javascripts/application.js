...
$(function () {
    ...
    if (Array.isArray(records)) {
        ...
        records.data.forEach(function (record, index) {
            target.append($(interpolate(template, {
                '@key': record,
                '@index': index
            })).removeAttr('data-render-template'));
        });
    }
...
!function (i) {
    ...
    window.GOVUK.Modules.AccordionWithDescriptions = function () {
        ...
        this.start = function (n) {
            ...
            function i() {
                n.prepend('<div class="subsection-controls js-subsection-controls"><button aria-expanded="false">Open all</button></div>')
            }
            ...
            function m() {
                (v = n.find(".js-subsection-controls button")).on("click", function () {
                    var o = "";
                    return "Open all" == v.text() ? (v.text("Close all"), v.attr("aria-expanded", "true"), o = "open", I("pageElementInteraction", "accordionAllOpened", {label: "Open All"})) : (v.text("Open all"), v.attr("aria-expanded", "false"), o = "close", I("pageElementInteraction", "accordionAllClosed", {label: "Close All"})), n.find(".js-subsection").each(function () {
            ...
            function b() {
                n.find(".subsection--is-open").length === w ? v.text("Close all") : v.text("Open all")
            }
